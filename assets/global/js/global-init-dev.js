// modified JS by Aguiton Rowell - 2024
// Compile all JS
...
// Modified by Rowell - 2024
const body = $('body');
const html = $('html');

function iqonSettings({version, layout, navheaderBg, headerBg, sidebarStyle, sidebarBg, sidebarPosition, headerPosition, containerLayout, direction}) {
...
iqonSettings.prototype.manageVersion = function() {
    switch(this.version) {
        case "light": 
...
iqonSettings.prototype.manageLayout = function() {
    switch(this.layout) {
        case "horizontal": 
...
iqonSettings.prototype.manageNavHeaderBg = function() {
...
iqonSettings.prototype.manageHeaderBg = function() {
...
iqonSettings.prototype.manageSidebarStyle = function() {
...
iqonSettings.prototype.manageSidebarBg = function() {
...
iqonSettings.prototype.manageSidebarPosition = function() {
...
iqonSettings.prototype.manageHeaderPosition = function() {
...
iqonSettings.prototype.manageContainerLayout = function() {
...
iqonSettings.prototype.manageRtlLayout = function() {
...
iqonSettings.prototype.manageResponsiveSidebar = function() {
